...
# Project imports. Importing app.models registers every model with Base.metadata
...
# Inject DATABASE_URL from our Settings (single source of truth, .env-backed).
# This overrides any sqlalchemy.url placeholder in alembic.ini.
